                ...
                {meteors.map((meteor) => (
                    <motion.div
                        ...
                        style={{
                            ...
                            background:
                                "linear-gradient(180deg, #ffffff, #6c63ff, transparent)",
                            borderRadius: "2px",
                            zIndex: 0,
                    ...
                    {[
                        {
                            icon: "⚡",
                            title: "Frontend",
                            desc: "Building beautiful UIs with React and modern CSS",
                        },
                        {
                            icon: "🔧",
                            title: "Backend",
                            desc: "Creating powerful APIs with Node.js and Express",
                        },
                        {
                            icon: "🗄️",
                            title: "Database",
                            desc: "Managing data with MongoDB and Mongoose",
                        },
                        {
                            icon: "🤖",
                            title: "AI",
                            desc: "Building Nova AI — a human-like AI assistant",
                        },
                    ].map((item, i) => (
                        <motion.div
                            key={i}
